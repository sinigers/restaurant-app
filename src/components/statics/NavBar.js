  ...
  return (
    <nav id="navbar-header" class="navbar navbar-expand-lg">
      <div class="container">
        ...
        >
          <img
            src="https://e7.pngegg.com/pngimages/224/1014/png-clipart-my-new-restaurant-logo-bistro-cafe-ermita-conrad-manila-restaurant-restaurant-logo-food-text.png"
            alt=""
          />
        </Link>
